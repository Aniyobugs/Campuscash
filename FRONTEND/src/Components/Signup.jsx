...
import { Button, TextField, Typography, Checkbox, FormControlLabel, MenuItem } from "@mui/material";
import Box from "@mui/material/Box";
import axios from "axios";
import React, { useState } from "react";
import { Link, useNavigate } from "react-router-dom";
    ...
    >
      <Box
        sx={{
          ...
          "&:hover": {
            boxShadow: "0 12px 36px rgba(132, 50, 255, 0.20)"
          }
        }}
      >
        <Typography
        ...
        <TextField
          ...
          sx={{mb:2}}
        >
          <MenuItem value="" disabled>Select Year/Class/Dept</MenuItem>
